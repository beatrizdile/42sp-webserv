...
class ServerManager {
   ...
   private:
    ...
    std::string processRequest(const std::string &root, const std::string &uri, const std::string &index, bool isAutoindex, const std::vector<Method> &methods, size_t clientBodySize, const std::map<std::string, std::string> &headers);
    std::string processGetRequest(const std::string &path, const std::string &uri, const std::string &index, bool isAutoindex);
    std::string processPostRequest(const std::string &path, const std::string &uri, const std::map<std::string, std::string> &headers);
